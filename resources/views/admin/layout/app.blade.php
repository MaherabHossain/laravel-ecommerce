...
<body>
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item"><a class="nav-link" href="{{ route('product') }}"><img class="menu-icon" src="{{asset('admin_template/images/menu_icons/02.png')}}" alt="menu icon"><span class="menu-title">Product</span></a></li>
           <li class="nav-item">
            <a class="nav-link" data-toggle="collapse" href="#general-pages" aria-expanded="false" aria-controls="general-pages"> <img class="menu-icon" src="{{asset('admin_template/images/menu_icons/08.png')}}" alt="menu icon"> <span class="menu-title">Category</span><i class="menu-arrow"></i></a>
            <div class="collapse" id="general-pages">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ route('category') }}">All category</a></li>
  ...
  <script src="{{ asset('admin_template/js/maps.js')}}"></script>
